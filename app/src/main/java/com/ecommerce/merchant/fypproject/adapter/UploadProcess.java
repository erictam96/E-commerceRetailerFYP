...
public class UploadProcess {
    ...
    public String HttpRequest(String requestURL,HashMap<String, String> PData) {
        ...
        try {
            ...
            httpURLConnectionObject.setReadTimeout(19000);//default 19000

            httpURLConnectionObject.setConnectTimeout(19000);//default 19000
