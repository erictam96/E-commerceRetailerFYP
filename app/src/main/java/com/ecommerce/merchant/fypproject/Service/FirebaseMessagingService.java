package com.ecommerce.merchant.fypproject.Service;
...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    //Notification Builder setting at HERE
    private void showNotification(String title ,String message,String GOTO) {
        PendingIntent pendingIntent;
        switch (GOTO){
            case "checkorder":
                Intent intentCheckOrder = new Intent(this, OrderConfirmActivity.class);
                ...
                break;
            case "packorder":
                Intent intentPackOrder = new Intent(this, MainActivity.class);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.notificationicon))
