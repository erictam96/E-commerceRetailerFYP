...
import com.ecommerce.merchant.fypproject.adapter.ChatList;
import com.ecommerce.merchant.fypproject.adapter.ChatListAdapter;
...
public class ChatListActivity extends AppCompatActivity {
    ...
    private String user;
    private String DisplayNamePathOnServer = "http://ecommercefyp.000webhostapp.com/retailer/customer_manage_user.php";
                ...
                reference2.addChildEventListener(new ChildEventListener() {
                                                     ...
                                                     public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                                                       ...
                                                       //  Log.e("getMsg2", Objects.requireNonNull(dataSnapshot.child("message").getValue()).toString());
                                                         ...
                                                         addtoList(getKey, message,time,Long.valueOf(dataSnapshot.child("time").getValue().toString()));
                                                     }
