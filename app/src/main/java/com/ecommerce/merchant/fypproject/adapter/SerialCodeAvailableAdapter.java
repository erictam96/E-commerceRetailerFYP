...
public class SerialCodeAvailableAdapter extends RecyclerView.Adapter<SerialCodeAvailableAdapter.ViewHolder> {
    ...
    public  SerialCodeAvailableAdapter(List<SerialCode> getDataAdapter, Context context, OnItemClick listener){
        super();
    ...
    @Override
    public SerialCodeAvailableAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.serial_list, parent, false);

        SerialCodeAvailableAdapter.ViewHolder viewHolder = new SerialCodeAvailableAdapter.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(final SerialCodeAvailableAdapter.ViewHolder Viewholder, final int position) {
        ...
        Viewholder.serialCode.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Viewholder.removeBut.setVisibility(View.GONE);
    }
    ...
    private void JSON_HTTP_CALL(final int clickedPosition) {
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                HashMapParams.put("assignSerial", dataAdapter.get(clickedPosition).getSerialID());
                HashMapParams.put("assignSerialOrderID", dataAdapter.get(clickedPosition).getOrderID());
                HashMapParams.put("assignSerialVariant", dataAdapter.get(clickedPosition).getProdVariant());
